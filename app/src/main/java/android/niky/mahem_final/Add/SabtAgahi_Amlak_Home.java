...
//                CallLayout=inflater.inflate(R.layout.call_layout,null);
        ...
        , meter.getText().toString(),Type.getText().toString(),AgahiDahande_type.getText().toString(),location.getText().toString()
                ,PhoneNum.getText().toString(),Email.getText().toString(),rahn.getText().toString()
                ,ejareh.getText().toString(),chat.isChecked(),email_check.isChecked());
...
//                GheimatMoredNazarLayout=inflater.inflate(R.layout.ghimat_mored_nazar_layout,null);
    ...
    void pick() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SabtAgahi_Amlak_Home.this);
